...
async function refreshStreamingForSelected() {
  ...
  openConfirmModal({
    message:
      "Refresh streaming services for the selected movie? This will update bootstrap_data.json.",
    onConfirm: async () => {
...
async function refreshStreamingAll() {
  openConfirmModal({
    message:
      "Refresh streaming services for all movies? This writes to bootstrap_data.json and may take several minutes.",
    onConfirm: async () => {
...
async function runOscarEnrichment() {
  ...
  openConfirmModal({
    message: `Run Oscar Awards enrichment (${modeLabel})? This calls OMDB API for each eligible movie and writes to bootstrap_data.json. Movies are processed in batches of 100.`,
    onConfirm: async () => {

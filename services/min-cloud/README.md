...
- `GET /v1/mov/now-playing` — persisted theater stays (TMDB now-playing + IMAX notes, plus admin pins)
- Admin Data Operations: Discs (Wikidata physical media) and Theater Stays (refresh/clear/pin)
